<template>
  <transition name="dialog-fade">
    <div v-if="show" class="dialog-overlay" @mousedown.self="handleOverlayClick">
      <div class="dialog-container" :class="`dialog-${severity}`">
        <!-- Header with Icon and Title -->
        <div class="dialog-header">
          <div class="icon-wrapper">
            <AlertTriangle v-if="severity === 'danger'" class="dialog-icon icon-danger" />
            <AlertCircle v-else-if="severity === 'warning'" class="dialog-icon icon-warning" />
            <HelpCircle v-else class="dialog-icon icon-info" />
          </div>
...
const props = defineProps({
  ...
  severity: {
    type: String as () => 'info' | 'warning' | 'danger',
    default: 'info'
  },
  confirmText: {
    type: String,
